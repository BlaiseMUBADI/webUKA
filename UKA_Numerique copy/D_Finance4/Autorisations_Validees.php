...
<div class="mb-2 p-1 bg-light rounded d-flex gap-3 flex-wrap justify-content-center">
  ...
  <!--  <div class="border p-2 rounded">
        <strong>Décaissement Total CDF :</strong> <span id="DecaissementCDF">0</span>
    </div>
    <div class="border p-2 rounded">
        <strong>Décaissement Total USD :</strong> <span id="DecaissementUSD">0</span>
    </div>
    <div class="border p-2 rounded">
        <strong>Décaissement du jour CDF :</strong> <span id="DecaissementCDF_jour">0</span>
    </div>
    <div class="border p-2 rounded">
        <strong>Décaissement du jour USD :</strong> <span id="DecaissementUSD_jour">0</span>
    </div> -->
</div>
