        ...
        <div class="sidebar pe-4 pb-3 "style="background-color: rgb(5, 23, 47); color: white;">
            ...
            <?php if ($categorie == "Caissière principale") : ?>
                <div class="navbar-nav w-100 ">
                    ...
                    <a href="Page_Principale_Finance.php?page=Autorisation_validee" class="nav-item nav-link bloc mt-2"><i class="fa fa-exchange-alt me-2 text-primary"></i>Autorisations</a>
                ...
                <div class="navbar-nav w-100 ">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Page_Principale_Finance.php?page=autorisation" class=" dropdown-item text-white a_menu" id="liste" style="color:white;"><i class="fa fa-money-bill-wave me-2"></i>Enregistrement</a>
