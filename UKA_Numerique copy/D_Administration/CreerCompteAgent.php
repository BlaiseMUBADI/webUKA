              ...
              if ($MatExiste == 1) 
               ...
               {*/
                $query="INSERT INTO compte_agent 
                  (Mat_agent,Login,Mot_passe,Etat,Categorie,Date_creation) VALUES ('$Matricule','$login','$motdepasse','$etat', '$fonction','$datecreation')";
                $con->exec($query);
                  ...
                  <div class="card-body">
                    <form action="" method="POST">
                      ...
                      <div class=" mb-3">
                        ...
                        <select name="Fonction" id="" class="form-select  shadow-sm" onchange="Affichage_promotion_toutes()">
                      ...
                      <div class=" mb-3">
                        ...
                        <input type="Date" name="Datecreation"id="dateField" class="form-control">
                      </div>
                      <div class=" mb-3">
