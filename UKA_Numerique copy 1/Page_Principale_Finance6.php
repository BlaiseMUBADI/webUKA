<?php
  ...
  // Traiter la déconnexion sécurisée
...
<head>
    ...
    <!-- Monitoring de session JavaScript -->
...
<body >
    ...
    <script src="D_Finance/js/jquery.min.js"></script>
    <script src="D_Finance/js/select2.min.js"></script>
    <!--<script src="D_Finance/js/Operation_Decaissement.js"></script> -->
