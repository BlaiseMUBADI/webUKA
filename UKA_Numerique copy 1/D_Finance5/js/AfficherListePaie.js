...
prom.addEventListener('change',(event) => {
  ...
  {
    var lien='D_Finance/API/APISelect_FA_Fixe.php?code_promo='+code_prom+'&Id_annee_acad='+idAnnee_Ac;  
  ...
  function AfficherListePaiement(code_prom,idAnnee_Ac)
{
   ...
   let TabListe = document.getElementById("TabListePaie");
    ...
    var tdA7 = document.createElement("th");
    ...
    td6.textContent = "Montant";
    td7.textContent = "Reste_FA";
    tdA7.textContent = "Enrol_Mi";
    td8.textContent = "Enrol_Gde_S";
    td9.textContent = "Enrol_2_S";
    td10.textContent = "Obs";
    ...
    var url='D_Finance/API/API_Select_Liste_Paie.php?code_promo='+code_prom+'&Id_annee_acad='+idAnnee_Ac;  
