<!-- 
    ============================================================================
    Include Session Monitor - À inclure dans le <head> HTML
    ============================================================================
    
    Ce fichier contient uniquement du JavaScript et doit être inclus dans 
    le <head> de toutes les pages nécessitant une authentification.
    
    IMPORTANT: Avant d'inclure ce fichier, vous devez inclure session_check.php
    au début de votre fichier PHP (avant toute sortie HTML).
    
    Usage: 
    <?php 
        include('D_Generale/session_check.php');  // Au début du fichier
    ?>
    <!DOCTYPE html>
    <html>
    <head>
        <?php include('D_Generale/include_session_monitor.php'); ?>  // Dans le head
    </head>
    
    Fonctionnalités:
    - Détection d'inactivité
    - Notification de connexions concurrentes
    - Mise à jour automatique de l'activité
-->

<!-- Chargement du script SessionMonitor -->
<script src="/webUKA/UKA_Numerique/D_Generale/JavaScript/session_monitor.js"></script>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const sessionMonitor = new SessionMonitor({
            ...
            apiBasePath: '/webUKA/UKA_Numerique/D_Generale/API_PHP/',
            logoutUrl: '/webUKA/UKA_Numerique/Fonctions_PHP/Deconnexion.php',
            ...
            onLogout: function(raison) {
                ...
                window.location.href = '/webUKA/UKA_Numerique/Fonctions_PHP/Deconnexion.php?raison=' + raison;
            },
