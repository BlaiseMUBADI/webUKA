                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="#" id="profil" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalProfil">Changer la photo de profil</a>
                            <a href="#" id="motdepasse" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalMotdePasse">Changer le mot de passe</a>
