    <div class="row g-4 mt-1" id="parentAccordion">
    <!-- Dépenses -->
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    <span id="toggleIconDepense" >➕</span> Rapports des recettes
                </button>
            </h2>
...
$annee_debut = $anneeRow['Annee_debut'];
        ...
        foreach ($donnees_realisation as $row) {
            ...
            echo '<div class="col-12 mt-2">
                    <div class=" rounded d-flex align-items-center justify-content-between p-1" style ="background-color:rgb(5,23,47); color: white;">
            ...
            if (!is_null($montant_prevu)) {
                ...
                echo '<h6 id="Montant" class="mb-2">
                        ...
                        Montant réalisé : ' . number_format($montant_realise, 2, ',', ' ') . ' $ &nbsp;&nbsp;&nbsp;&nbsp; 
                        Différence : ' . number_format($diff, 2, ',', ' ') . ' $
                      </h6>
...
<div class="container-fluid pt-4 px-4 " id="block_depenses2" style="display: block;">
                <div class="row g-4">
