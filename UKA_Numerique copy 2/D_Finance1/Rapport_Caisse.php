...
<div class="encaissement-container">
  <div class="encaissement-header">Rapport de Caisse</div>
  ...
  <div class="input-container">
    ...
    <select id="Select" class="custom-select">
      <option value="CDF">Rapport de caisse CDF</option>
      <option value="USD">Rapport de caisse USD</option>
    </select>
...
<div class="table-container" id="tablePrint">
    <div class="table-header">
        <u> 
         </u>

        <button id="btn-action" class="action-button">Exporter</button>
        <button id="btn-print" class="print-button"onclick="imprimer()"><i class="fas fa-print icon-style"style="font-size:1.3em;"> </i></button>
    </div>
     
  <table class="table" id="tableRapport">
    <thead>
...
<script src="D_Finance/js/Rapport_Caisse.js"></script>
