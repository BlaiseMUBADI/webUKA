    ...
    <body>
        ...
        <script>
            ...
            function verifierStatutDemande() {
                fetch('D_Generale/API_PHP/check_request_status.php', {
                    method: 'POST',
                ...
                .then(data => {
                    ...
                    // Gérer l'expiration ou les erreurs
                    if (data.expired || (!data.success && data.message)) {
                        ...
                        statutDiv.innerHTML = `
                            ...
                            <p style="margin: 15px 0 0 0; color: #dc2626; font-weight: bold;">
                                ${data.expired ? 'Demande expirée' : 'Erreur'}
                            </p>
                            <p style="margin: 10px 0 0 0; color: #64748b; font-size: 0.9rem;">
                                ${data.message || 'Temps d\'attente dépassé. Veuillez réessayer.'}
                            </p>
                        `;
            ...
            function confirmerActivation() {
                fetch('D_Generale/API_PHP/confirm_new_session.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        demande_id: demandeId,
