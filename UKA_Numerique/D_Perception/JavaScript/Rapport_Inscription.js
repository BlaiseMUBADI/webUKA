...
console.log("Je suis dans le rapport inscription"); 
...
document.addEventListener('DOMContentLoaded', function(event) {
  ...
  if (promo !== null) {
    promo.addEventListener('change', function() {
      ...
      var url='API_PHP/API_Rapport_Inscription.php?datepaie='+datepaie+'&promo='+promo_filier+'&annee_acad='+annee_acad;
...
// CODE DUPLIQUÉ SUPPRIMÉ - Tout est maintenant dans le DOMContentLoaded
