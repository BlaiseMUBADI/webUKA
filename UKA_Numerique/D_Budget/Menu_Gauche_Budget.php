      ...
      <ul class="nav-links m-0 p-0">
        ...
        <li id="Li_Perception">
          ...
          <div id="Menu_contextuel_Perception"
            ...
            <a class="dropdown-item" 
              href="Principale_Budget.php<?php if($_SESSION['Categorie']=="Guichetier") echo"?page=guichet";
            ...
            <a class="dropdown-item" 
              href="Principale_Budget.php<?php 
            ...
            <a class="dropdown-item" 
              href="Principale_Budget.php<?php if($_SESSION['Categorie']=="Guichetier") echo"?page=Rapport_paie";
                  else echo"?page=non_acces";?>">
            ...
            <a class="dropdown-item" 
              href="Principale_Budget.php<?php if($_SESSION['Categorie']=="Guichetier") echo"?page=manip_transaction";
                  else echo"?page=non_acces";?>">
        ...
        <li id="Li_Budget">
          ...
          <div id="Menu_contextuel_Budget"
            ...
            <a class="dropdown-item" 
              href="Principale_Budget.php<?php  if($_SESSION['Categorie']=="Comptable") echo"?page=ab_taux_jours";
                  else echo"?page=non_acces";?>">
            ...
            <a class="dropdown-item" 
              href="Principale_Budget.php<?php if($_SESSION['Categorie']=="Comptable") echo"?page=ab_modalite_paie";
                  else echo"?page=non_acces";?>">
        ...
        <li>
          <a href="Principale_Budget.php<?php if($_SESSION['Categorie']=="Comptable") echo"?page=Rapport_paie";else echo"?page=non_acces"; ?>"
          class="a_menu disabled">
        ...
        <li>
          <a href="Principale_Budget.php<?php if($_SESSION['Categorie']=="Guichetier") echo"?page=Inscription";else echo"?page=non_acces"; ?>"
          class="a_menu disabled">
